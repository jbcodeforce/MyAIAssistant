...
* A project may be linked to an organization
* The status of a project is one of :
...
The project view can support filtering by organizations, and project status. 
...
The detail view present the creation date and when the project was updarted. 

Next Step includes a link to creating a task when the step may become work that need to be prioritized. The link opens to the new task form.

![](./images/step_to_task.png)
