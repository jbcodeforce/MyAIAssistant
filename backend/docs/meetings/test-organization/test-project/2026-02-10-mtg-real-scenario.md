# Notes updated by AI: Attendees listed: Greg, Michael, Chris, and 8 others. Key issues include Kafka performance, visibility limitations, and data consistency.
## Key Points
- Kafka lag issues
- Visibility gaps
...
## Next Steps
- to_be_decided (assigned to to_be_decided)
