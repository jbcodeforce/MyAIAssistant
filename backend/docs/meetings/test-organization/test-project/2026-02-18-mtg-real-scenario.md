# Notes updated by AI: Meeting notes cleaned: improved clarity and conciseness.
## Key Points
- Kafka lag and data visibility issues
- Data lineage missing
- RBAC complexity challenges

## Next Steps
- Upgrade connectors and optimize consumer settings (assigned to to_be_decided)
